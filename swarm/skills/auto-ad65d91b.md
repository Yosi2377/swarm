# Auto-Generated Skill: endpoint
# Generated from 6 lessons
# Pattern detected: "endpoint" appeared 5 times

## Lessons Learned
- When calling external APIs in loops, use at least 500ms delay. For bulk operations, use 1000ms+ or batch endpoints.
...
## Rules
When encountering situations related to "endpoint":
- When calling external APIs in loops, use at least 500ms delay. For bulk operations, use 1000ms+ or batch endpoints.
- 🔍 Evaluating thread 2809 for agent koder...
📝 Auto-committing 5 workspace files...
[master 658970f] #2809: auto-commit workspace changes (evaluator)
